...
# the following line calculates a single Monte Carlo run corresponding to Figure 3 (top-left), i.e. the Fourier simulation
data <- simulate(1)

### uncomment the sript below to obtain results for the fourier simulations
# Data <- lapply(1:100,simulate,mc.cores=25)
