...
simulate <- function(sim){
  ...
  for(pp in 1:4){ 
    ...
    BWs <- c(6.717514, 6.7175144, 5.1346734, 3.0000000, 3.0000000, 3.0000000, 3.0000000) # manually read from commented
                                                                                         # results above
    t <- Sys.time()                                                                
    C_hat <- smooth4D(X,BWs[pp],BWs[pp],T)
...
save(Data, file="sparse_fourier_empirical_data.RData")
