...
kronPCA <- function(X,R,maxiter,B=NULL){
...
# number of folds
  ...
  for(fold in 1:Folds){
    ...
    Res <- kronPCA(Xtrain,maxR,maxiter)
    for(r in 1:maxR){
...
pcg2 <- function(Est,Y,eps,Ig=NULL,tol=1e-10){
