...
The .txt files were saved in a folder, labeled "death_rates", and used
[mortality_data_read.R](separable_plus_banded_model/mortality_data_read.R) to produce `mortality_data.RData`.
